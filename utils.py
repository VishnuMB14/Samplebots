...
from info import AUTH_CHANNELS, REQUEST_TO_JOIN_CHANNELS, TRY_AGAIN_BTN, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORTLINK_URL, SHORTLINK_API, IS_SHORTLINK, LOG_CHANNEL, TUTORIAL, GRP_LNK, CHNL_LNK, CUSTOM_FILE_CAPTION
